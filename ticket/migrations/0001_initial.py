# -*- coding: utf-8 -*-
# Generated by Django 1.9.1 on 2016-03-01 14:02
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('department', models.CharField(choices=[('T', 'Technician'), ('O', 'Other')], max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('priority', models.CharField(choices=[('H', 'High'), ('M', 'Medium'), ('L', 'Low')], default=None, max_length=2)),
                ('created_by', models.TextField(max_length=30)),
                ('created_date', models.DateField(auto_now_add=True)),
                ('updated_date', models.DateField(auto_now=True)),
                ('status', models.CharField(choices=[('R', 'Ready'), ('IP', 'In Progress'), ('WP', 'Waiting on Part'), ('WC', 'Waiting on Customer'), ('C', 'Completed')], default='R', max_length=2)),
                ('issue_type', models.CharField(max_length=30)),
                ('issue', models.CharField(max_length=255)),
                ('assigned_tech', models.CharField(max_length=30)),
                ('completed', models.BooleanField(default=False)),
                ('customer_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ticket.Customer')),
            ],
        ),
    ]
